...
var Watcher = function (_EventEmitter) {
  ...
  function Watcher(initialFiles, config) {
    ...
    _this.active = true;
    _this.config = config;
    _this.disabled = new Set();
    _this.chokidar = _chokidar2.default.watch([], {
      usePolling: config.usePolling,
      ignoreInitial: true
    });
    _this.chokidar.on('add', function (filePath) {
      return !_this.disabled.has(filePath) && _this.emit('change', filePath);
    });
    _this.chokidar.on('unlink', function (filePath) {
      return !_this.disabled.has(filePath) && _this.emit('unlink', filePath);
    });
  ...
  _createClass(Watcher, [{
    ...
    key: 'enable',
    value: function enable(filePath) {
      this.disabled.delete(filePath);
    }
  }, {
    key: 'disable',
    value: function disable(filePath) {
